...
class LaporanKemajuanBudgetsExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    /**
    ...
    {
        $budgets = DocumentBudget::where('document_id', $this->document_id)->where('flag', 0)->get();
