            ...
            <form action="/login" method="post">
                ...
                <div class="form">
                    ...
                    <div class="username">
                        ...
                        <input class="input @error('username') is-invalid @enderror" type="text" placeholder="Username"
                    ...
                    <div class="password">
                        ...
                        <input id="password" class="input @error('password') is-invalid @enderror" type="password"
